 ...
 */
namespace yuncms\wifi\controllers;
...
class IndexController extends \yii\web\Controller
{
     ...
     * 微博认证页面
     */
    public function actionWeiboAuth()
    {
     ...
     * 一键登录
     */
    public function actionAkeyVerify()
    {
        try {
            $smslog = DD('SmsLog');
     ...
     * 虚拟短信认证
     */
    public function actionVirtualSendSms()
    {
        $phonenumber = I('post.phonenumber');
        $return_data = array();
        try {
